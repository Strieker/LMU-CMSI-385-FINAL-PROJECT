...
n = NFAStdin("/Users/sas/Desktop/McLovin It/Junior Year/Work Hard/theory/LMU-CMSI-385-FINAL-PROJECT/nfa1.in")
print(n.start_state)
print(n.accept_states)
print(n.states)
print(n.transitions_switch)